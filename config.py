...
class Config:
    ...
    PKI65_DIR = os.getenv("PKI65_DIR")
    PKI44_DIR = os.getenv("PKI44_DIR")
    ...
    CONF_DIR_PKI65 = os.getenv("CONF_DIR_PKI65")
    CONF_DIR_PKI44 = os.getenv("CONF_DIR_PKI44")
...
# Validate required variables
    ...
    def validate(cls):
        required_vars = [
            "OPENSSL",
            "ROOT_CA", "MPU_CA", "MCU_CA", "TLS_CA",
            "SERVER", "CLIENT",
            "ROOT_CA_DIR", "MPU_CA_DIR", "MCU_CA_DIR",
            "MPU_CERTS_DIR", "MCU_CERTS_DIR", "TLS_CA_DIR", "TLS_CERTS_DIR",
            "ROOT_CA_DB", "MPU_CA_DB", "MCU_CA_DB", "TLS_CA_DB",
            "ROOT_CA_CRL", "MPU_CA_CRL", "MCU_CA_CRL", "TLS_CA_CRL",
            "MPU_CA_CONF", "MCU_CA_CONF", "TLS_CA_CONF", "SERVER_CONF",
            "CLIENT_CONF",
            "MPU_CA_KEY", "MCU_CA_KEY",
            "MPU_CA_PASSWORD", "MCU_CA_PASSWORD", "TLS_CA_PASSWORD",
            "TLS_CA_KEY",
            "ROOT_CA_CERT", "MPU_CA_CERT", "MCU_CA_CERT", "TLS_CA_CERT", "TLS_CA_CHAIN", "MPU_CA_CHAIN", "MCU_CA_CHAIN", "APP_CERT", "APP_CA_CERT", "APP_ROOT_CA_CERT", "APP_KEY", "APP_CA_KEY", "APP_ROOT_CA_KEY", "APP_CHAIN", "PKI65_DIR", "PKI44_DIR", "CONF_DIR_PKI65", "CONF_DIR_PKI44"
